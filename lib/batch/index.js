...
const highLevelHeaderOverrides = ['serviceClassCode', 'companyDiscretionaryData', 'companyIdentification', 'standardEntryClassCode'];
const highLevelControlOverrides = ['addendaCount', 'entryHash', 'totalDebit', 'totalCredit'];
class Batch {
    constructor(options, autoValidate) {
        ...
        (0, utils_1.overrideLowLevel)(highLevelHeaderOverrides, options, this);
        (0, utils_1.overrideLowLevel)(highLevelControlOverrides, options, this);
