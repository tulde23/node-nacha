...
function overrideLowLevel(values, options, self) {
    ...
    if (Object.keys(self).length === 0)
        return;
    if (isBatchOverrides(values) && isBatchOptions(options) && self instanceof index_js_1.default) {
