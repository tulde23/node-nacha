...
exports.newLineChar = exports.computeBusinessDay = exports.isBusinessDay = exports.formatTime = exports.formatDate = exports.getNextMultipleDiff = exports.getNextMultiple = exports.unique = exports.overrideLowLevel = exports.isEntryAddendaOptions = exports.isEntryAddendaOverrides = exports.isEntryOptions = exports.isEntryOverrides = exports.isBatchOptions = exports.isBatchHeaderOverrides = exports.isBatchOverrides = exports.compareSets = exports.parseLine = exports.generateString = exports.testRegex = exports.computeCheckDigit = exports.pad = void 0;
const index_js_1 = __importDefault(require("./batch/index.js"));
const achParser_js_1 = __importDefault(require("./class/achParser.js"));
const index_js_2 = __importDefault(require("./entry-addenda/index.js"));
const index_js_3 = __importDefault(require("./entry/index.js"));
...
function isEntryOptions(arg) {
    if (typeof arg !== 'object')
        return false;
    if (Object.keys(arg).length === 0)
        return false;
    if ('fields' in arg) {
        if ('amount' in arg.fields)
            return true;
    }
    return false;
}
exports.isEntryOptions = isEntryOptions;
...
function overrideLowLevel(values, options, self) {
    if (!Array.isArray(values))
        throw new Error('overrideLowLevel() requires an array of values to override');
    if (typeof options !== 'object')
        throw new Error('overrideLowLevel() requires an object of options to override');
    if (typeof self !== 'object')
        throw new Error('overrideLowLevel() requires an object to override');
    if (values.length === 0)
        return;
    ...
    if (Object.keys(self).length === 0)
        return;
    if (isBatchOverrides(values) && isBatchOptions(options) && (self instanceof index_js_1.default || self instanceof achParser_js_1.default)) {
    ...
    if (isEntryOverrides(values) && isEntryOptions(options) && self instanceof index_js_3.default) {
        values.forEach((field) => {
            if (options[field])
                self.set(field, options[field]);
        });
    }
    if (isEntryAddendaOverrides(values) && isEntryAddendaOptions(options) && self instanceof index_js_2.default) {
        values.forEach((field) => {
            if (options[field])
                self.set(field, options[field]);
        });
